...
declare global {
  namespace iobJS {
    ...
    interface PartialStateObject
      extends Partial<Pick<StateObject, '_id' | 'native' | 'enums' | 'type'>> {
    ...
    interface PartialChannelObject
      extends Partial<
        Pick<ChannelObject, '_id' | 'native' | 'enums' | 'type' /* | "acl"*/>
      > {
    ...
    interface PartialDeviceObject
      extends Partial<
        Pick<DeviceObject, '_id' | 'native' | 'enums' | 'type' /* | "acl"*/>
      > {
    ...
    interface PartialOtherObject
      extends Partial<
        Pick<OtherObject, '_id' | 'native' | 'enums' | 'type' /* | "acl"*/>
      > {
    ...
    type GetBinaryStatePromise = Promise<
      NonNullCallbackReturnTypeOf<GetBinaryStateCallback>
    >;
    ...
    type GetObjectCallback = (
      err?: string | null,
      obj?: iobJS.Object,
    ) => void | Promise<void>;
    type GetObjectPromise = Promise<
      NonNullCallbackReturnTypeOf<GetObjectCallback>
    >;
    ...
    interface QueryResult extends Iterable<string> {
       ...
       */
      setState<T extends StateValue>(
        state: T | State<T> | Partial<State<T>>,
        ack?: boolean,
        callback?: SetStateCallback,
      ): this;
      setStateAsync<T extends StateValue>(
        state: T | State<T> | Partial<State<T>>,
        ack?: boolean,
      ): Promise<void>;
   ...
   */
  function setState<T extends iobJS.StateValue>(
    id: string,
    state: T | iobJS.State<T> | Partial<iobJS.State<T>>,
  ...
  function setStateAsync<T extends iobJS.StateValue>(
    id: string,
    state: T | iobJS.State<T> | Partial<iobJS.State<T>>,
    ack?: boolean,
   ...
   */
  function setStateDelayed<T extends iobJS.StateValue>(
    id: string,
    state: T | iobJS.State<T> | Partial<iobJS.State<T>>,
    delay: number,
  ...
  function getObject(
    ...
    callback: iobJS.GetObjectCallback,
  ): void;
  function getObjectAsync(
    id: string,
    enumName?: string | true,
  ): iobJS.GetObjectPromise;
